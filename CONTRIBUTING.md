# Contributing to zzdataframe2graphic

This outlines how to propose a change to zzdataframe2graphic. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rgt47/zzdataframe2graphic", fork = TRUE)`.
...
Please note that the zzdataframe2graphic project is released with a
[Contributor Code of
Conduct](https://rgt47.github.io/zzobj2fig/CODE_OF_CONDUCT.md). By
