...
# o2f_inline generates PDF output
result <- o2f_inline(
  mtcars[1:5, 1:3],
  format = "pdf",
...
# o2f_inline generates PNG output
...
# o2f_inline accepts width parameter
result <- o2f_inline(
  mtcars[1:3, 1:2],
  width = "3in",
  format = "pdf",
...
# o2f_inline accepts align parameter
result_left <- o2f_inline(
  mtcars[1:3, 1:2],
  align = "left",
  format = "pdf",
...
# o2f_inline works with lm objects
...
# o2f_coef generates coefficient table
...
# o2f_inline auto-generates filename if NULL
result <- o2f_inline(
  mtcars[1:3, 1:2],
  filename = NULL,
  format = "pdf",
...
expect_true(file.exists(result))
expect_true(grepl("^o2f_inline_", basename(result)))

# o2f_inline accepts caption and label
result <- o2f_inline(
  mtcars[1:3, 1:2],
...
# o2f_coef accepts caption and label
model <- lm(mpg ~ cyl, data = mtcars)
result <- o2f_coef(
  model,
...
result <- zzobj2fig:::build_inline_latex(
  path = "test.pdf",
  width = "3in",
  height = NULL,
  align = "center",
...
# o2f_inline accepts caption_position
result <- o2f_inline(
  mtcars[1:3, 1:2],
  caption = "Test",
  caption_position = "below",
...
# o2f_inline accepts frame parameters
result <- o2f_inline(
  mtcars[1:3, 1:2],
  frame = TRUE,
  frame_color = "gray",
...
# o2f_inline accepts background parameter
result <- o2f_inline(
  mtcars[1:3, 1:2],
...
# o2f_inline accepts frame and background together
result <- o2f_inline(
  mtcars[1:3, 1:2],
  frame = TRUE,
  frame_color = "blue!50",
...
# o2f_coef accepts frame parameters
model <- lm(mpg ~ cyl, data = mtcars)
result <- o2f_coef(
  model,
  frame = TRUE,
