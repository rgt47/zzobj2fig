...
#'   Typst import directive and a \code{zzo2f_siunitx} spec that can
...
#' @return A \code{zzo2f_siunitx} object (character directive lines
...
#' }
#' @export
zzo2f_siunitx <- function(table_format = "3.2",
  ...
  structure(
    preamble,
    class = c("zzo2f_siunitx", "character"),
...
#' Print method for zzo2f_siunitx
#' @param x A \code{zzo2f_siunitx} object.
#' @param ... Ignored.
#' @return Invisibly \code{x}.
#' @export
print.zzo2f_siunitx <- function(x, ...) {
  cat("zzo2f_siunitx (Typst metro adapter):\n")
