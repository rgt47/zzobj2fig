...
#'   \code{zzo2f()}. Parallel in purpose to \code{o2f_tidy()},
#'   \code{o2f_coef()}, \code{o2f_rms_compare()}.
#'
#' @name zzo2f-stat
NULL
...
#' @param ... Forwarded to \code{zzo2f.default()}.
#' @return Output-file path from \code{zzo2f()}.
#' @examples
#' \dontrun{
...
#' }
#' @export
zzo2f_tidy <- function(x, tidy_args = list(),
  ...
  zzo2f.default(tidy_df, ...)
}

#' Coefficient table rendered inline with the Typst backend
#'
#' @description Convenience wrapper that renders a fitted model as a
#'   coefficient table via \code{zzo2f_inline()}. Matches the shape
#'   of \code{o2f_coef()}, minus LaTeX-specific arguments
...
#' @param ... Forwarded to \code{zzo2f_inline()} / \code{zzo2f()}.
#' @return Path to the rendered file.
#' @export
zzo2f_coef <- function(model,
                       width = "3in",
                       align = "center",
                       digits = 3L,
                       theme = "minimal",
...
#' @param zzo2f_args List of arguments forwarded to \code{zzo2f()}.
#' @return Path to the rendered file.
#' @export
zzo2f_rms_compare <- function(...,
                              digits = 3L,
                              exponentiate = FALSE,
