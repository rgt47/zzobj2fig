...
#'
#' @description Functions to generate LaTeX code for including o2f-generated
...
#'
#' @export
o2f_include_inline <- function(path,
                                width = "\\textwidth",
                                center = TRUE,
                                vspace = NULL,
                                cat = TRUE) {
...
#'
#' @export
o2f_include_wrap <- function(path,
                              placement = "r",
                              wrap_width = "0.5\\textwidth",
                              width = NULL,
                              caption = NULL,
...
#'
#' @export
o2f_include_sidebyside <- function(path1, path2,
                                    caption1 = NULL,
                                    caption2 = NULL,
                                    label1 = NULL,
                                    label2 = NULL,
...
#'
#' @description Generate cross-reference commands for o2f tables.
#'
...
#'
#' @export
o2f_ref <- function(label, type = c("ref", "autoref", "pageref", "nameref"),
                    cat = TRUE) {
  type <- match.arg(type)
...
#'
#' @export
o2f_include_margin <- function(path,
                                caption = NULL,
                                label = NULL,
  ...
  # Note: tufte uses same marginfigure syntax as sidenotes
  result <- switch(method,
    sidenotes = margin_sidenotes(pdf_path, caption, label, width, offset),
    marginpar = margin_marginpar(pdf_path, width),
    tufte = margin_sidenotes(pdf_path, caption, label, width, offset),
...
#'
#' @export
o2f_margin_packages <- function(method = c("sidenotes", "marginpar",
                                            "tufte", "marginnote")) {
  method <- match.arg(method)
