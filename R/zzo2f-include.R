...
#'     direct Typst equivalent. \code{zzo2f_include_wrap()} emits a
...
#'   suffix is added, because \code{zzo2f()} emits already-sized
#'   Typst output.
#' @keywords internal
...
#' }
#' @export
zzo2f_include_inline <- function(path,
                                 width = "\\textwidth",
                                 center = TRUE,
                                 vspace = NULL,
                                 cat = TRUE) {
...
#' @return Character; printed when \code{cat = TRUE}.
#' @export
zzo2f_include_wrap <- function(path,
                               placement = c("r", "l",
                                             "right", "left"),
...
#' @return Character; printed when \code{cat = TRUE}.
#' @export
zzo2f_include_sidebyside <- function(path1, path2,
                                     caption1 = NULL,
                                     caption2 = NULL,
                                     label1 = NULL,
                                     label2 = NULL,
...
#' @return Character; printed when \code{cat = TRUE}.
#' @export
zzo2f_include_margin <- function(path,
                                 caption = NULL,
                                 label = NULL,
                                 width = "4cm",
                                 offset = "100%",
...
#' @export
zzo2f_margin_packages <- function(method = NULL) {
  message(
